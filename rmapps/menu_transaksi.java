...
public class menu_transaksi extends javax.swing.JFrame {
    ...
    try {
        if (!ShowNama.getText().isEmpty()) {
            if (!jikakeluar()) {
                ...
                String rowsAffectedStr = con.queryInsert("tb_transaksi", kolom, isi);
            int rowsAffected = Integer.parseInt(rowsAffectedStr);
            if (rowsAffected > 0) {
                JOptionPane.showMessageDialog(this, "Data Berhasil Disimpan");
                cekstatus();
                add_peminjam();
            } else {
                JOptionPane.showMessageDialog(this, "Gagal menyimpan data ke dalam database");
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/lease.png"))); // NOI18N
        jLabel1.setText("Rent APPs| Sewa Motor");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Form Cek Motor", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
        ...
        tabeltransaksi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_transaksi", "Peminjam", "No. Polisi", "Harga", "Tgl. Pinjam", "Tgl. Kembali", "Lama Pinjam", "Total"
            }
        ));
